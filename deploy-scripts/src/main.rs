...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_test_basic"; // Example
    ...
    use test_basic::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("test_basic.receive".to_string()),
